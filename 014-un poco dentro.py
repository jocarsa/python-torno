...
for frame_num in range(total_frames):
    ...
    if distance_from_center > radius:
        ...
        # This time, move it a small step inward from the boundary
        x = center_x + (radius - 5) * math.cos(angle_to_center)  # Move 5 pixels inward
        y = center_y + (radius - 5) * math.sin(angle_to_center)  # Move 5 pixels inward
