...
for frame_num in range(total_frames):
    # Draw the anchored brush on the rotating canvas
    ...
    if frame_num % 60 == 0:
        ...
        stats_text = f'Time Passed: {elapsed_time:.2f}s | Time Remaining: {time_remaining:.2f}s | ' \
        ...
        cv2.putText(rotated_canvas, stats_text, (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2, cv2.LINE_AA)
