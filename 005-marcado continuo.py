...
for frame_num in range(total_frames):
    ...
    # Draw the anchored brush on the rotated canvas
    cv2.circle(rotated_canvas, (x, y), 10, brush_color, -1)
    
    # Update the canvas with the new rotated frame
